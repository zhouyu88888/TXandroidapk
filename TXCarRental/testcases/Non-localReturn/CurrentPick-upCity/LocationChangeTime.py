...
# 车辆列表含报价
driver.find_element(AppiumBy.XPATH, "//android.view.View[contains(@content-desc, '个报价')]").click()
sleep(3)

# 车辆详情点击
driver.find_element(AppiumBy.XPATH, "//android.view.View[contains(@content-desc, '/天')]").click()
sleep(3)
