...
# 汽车票列表，点击“去看看”
driver.find_element(AppiumBy.XPATH, "//*[contains(@content-desc, '去看看')]").click()
sleep(1)
driver.keyevent(4)

# 汽车票列表，点击“去瞅瞅”
driver.find_element(AppiumBy.XPATH, "//*[contains(@content-desc, '去瞅瞅')]").click()
sleep(1)
driver.keyevent(4)
